      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            {onBecomeSeller && (
              <div className="mt-4">
                <button onClick={onBecomeSeller} className="bg-white text-khaki-brown-900 text-sm font-semibold px-4 py-2 rounded-md hover:bg-khaki-brown-100">Become a Seller</button>
              </div>
            )}
          </div>
          <div>
